local translation = {
  ...
  UIText = {
    General = {
      ...
      no = "Nein",
      apply  = "Anwenden",
      default = "Auf Standard Zurücksetzen",
      presets_comboBox = "Nutze Voreinstellung:",
      presets_comboBox_tooltip = "Wähle eine Voreinstellung für Anti-Ghosting.",
      ...
      settings_restored = "Vorherige Einstellungen wieder hergestellt.",
      settings_save = "Speichern",
      settings_saved = "[ ! ] Deine Einstellungen werden gespeichert.",
      settings_applied_onfoot  = "[ ! ] Ziehe deine Waffe erneut um Änderungen anzuwenden",
      ...
      info_getOut = "[ ! ] Für diese Option, muss V das Fahrzeug erst verlassen.",
      info_getIn = "[ ! ] Für diese Option, muss V in einem Fahrzeug sein.",
      info_aimOnFoot = "[ ! ] Es kann jeweils eine Ziel-/Blockierungsfunktion aktiviert werden.",
      info_diagnostics = "Mögliche Konflikte mit anderen Mods erkannt.",
      info_modNotReady = "[ ! ] Mod funktioniert nicht. Bitte die logs kontrollieren...",
      ...
      info_vectorsMissing = "Das 'Vectors' Modul konnte nicht gefunden werden.",
    ...
    Info = {
      ...
      modNotReady = "Die Mod ist auf Probleme gestoßen:"
    },
    Vehicles = {
      tabname = "Fahrzeuge",
      MaskingPresets = {
    ...
    Options = {
      ...
      Benchmark = {
        ...
        benchmarkPauseOverlay = "[ ! ] Benchmark ist pausiert. Schließe das CET-Overlay, um fortzufahren.",
        ...
        benchmarkEnabled = "Benchmark aktiv.",
        benchmarkFinished = "Benchmark abgeschlossen.",
